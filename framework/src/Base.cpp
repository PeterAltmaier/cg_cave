...
void generatePlane(float *vertices, unsigned int v_size, face *faces, unsigned int f_size, HeightGenerator generator) {
    ...
    //fl�chen und deren Normale berechnen
    ...
    //vertex normalen berechnen aus gewichtetem Durchschnitt, die vertices am Rand m�ssen gesondert betrachtet werden, erstmal egal, f�rs gro�e ganze
